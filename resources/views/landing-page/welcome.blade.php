    ...
    <section class="container-fluid slider-area course-section">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="courseTabButton" id="" data-toggle="tab" href="#upcoming-course" role="tab"
                                   aria-controls="upcoming-course"
                                   aria-selected="true">{{strtoupper(__('generic.up_coming_course'))}}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="tab-content">
                    ...
                    @elseif($upcomingCourses->isEmpty())
                        <div id="upcoming-course" class="tab-pane fade">
                            <div class="col-md-12">
                                <div class="alert text-danger text-center">
                                    {{__('generic.no_upcoming_course_found')}}
                                </div>
                            </div>
                        </div>
                    @else
        ...
        @if($upcomingCourses->count() > 4)
            <div class="col-md-12 text-center pt-3">
                <a href="{{ route('frontend.course_search') }}" target="_blank"
